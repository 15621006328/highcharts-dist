/**
 * @license Highcharts JS v8.2.2 (2020-12-15)
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Treemap/TreemapPoint.js', [_modules['Core/Series/Series.js'], _modules['Mixins/DrawPoint.js'], _modules['Core/Utilities.js']], function (BaseSeries, DrawPointMixin, U) {
        /* *
         *
         *  (c) 2014-2020 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Series/Treemap/TreemapComposition.js', [_modules['Core/Series/Series.js'], _modules['Series/Treemap/TreemapUtilities.js'], _modules['Core/Utilities.js']], function (BaseSeries, TreemapUtilities, U) {
        /* *
         *
         *  (c) 2014-2020 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Series/Treemap/TreemapSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Color/Color.js'], _modules['Mixins/ColorMapSeries.js'], _modules['Core/Globals.js'], _modules['Mixins/LegendSymbol.js'], _modules['Core/Color/Palette.js'], _modules['Series/Treemap/TreemapAlgorithmGroup.js'], _modules['Series/Treemap/TreemapPoint.js'], _modules['Series/Treemap/TreemapUtilities.js'], _modules['Mixins/TreeSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, Color, ColorMapMixin, H, LegendSymbolMixin, palette, TreemapAlgorithmGroup, TreemapPoint, TreemapUtilities, TreeSeriesMixin, U) {
        /* *
         *
         *  (c) 2014-2020 Highsoft AS
         *
    ...
    _registerModule(_modules, 'Series/Sunburst/SunburstPoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
        ...
        var _a = BaseSeries.seriesTypes,
            LinePoint = _a.line.prototype.pointClass,
            TreemapPoint = _a.treemap.prototype.pointClass;
    ...
    _registerModule(_modules, 'Series/Sunburst/SunburstUtilities.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
         *  This module implements sunburst charts in Highcharts.
         *
    ...
    _registerModule(_modules, 'Series/Sunburst/SunburstSeries.js', [_modules['Core/Series/Series.js'], _modules['Mixins/CenteredSeries.js'], _modules['Core/Globals.js'], _modules['Series/Sunburst/SunburstPoint.js'], _modules['Series/Sunburst/SunburstUtilities.js'], _modules['Mixins/TreeSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, CenteredSeriesMixin, H, SunburstPoint, SunburstUtilities, TreeSeriesMixin, U) {
        /* *
         *
         *  This module implements sunburst charts in Highcharts.
         *
