/**
 * @license Highmaps JS v8.2.2 (2020-12-15)
 *
 * Tilemap module
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Tilemap/TilemapPoint.js', [_modules['Core/Series/Series.js'], _modules['Mixins/ColorSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, ColorSeriesModule, U) {
        /* *
         *
         *  Tilemaps module
         *
        ...
        var _a = BaseSeries.seriesTypes,
            ...
            HeatmapPoint = _a.heatmap.prototype.pointClass;
    ...
    _registerModule(_modules, 'Series/Tilemap/TilemapShapes.js', [_modules['Core/Series/Series.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (BaseSeries, H, U) {
        /* *
         *
         *  Tilemaps module
         *
    ...
    _registerModule(_modules, 'Series/Tilemap/TilemapSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Globals.js'], _modules['Series/Tilemap/TilemapPoint.js'], _modules['Series/Tilemap/TilemapShapes.js'], _modules['Core/Utilities.js']], function (BaseSeries, H, TilemapPoint, TilemapShapes, U) {
        /* *
         *
         *  Tilemaps module
         *
