...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Cylinder/CylinderPoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
        ...
        var ColumnPoint = BaseSeries.seriesTypes.column.prototype.pointClass;
        var extend = U.extend;
        /* *
         *
         *  Class
    ...
    _registerModule(_modules, 'Series/Cylinder/CylinderSeries.js', [_modules['Core/Series/Series.js'], _modules['Series/Cylinder/CylinderPoint.js'], _modules['Core/Utilities.js']], function (BaseSeries, CylinderPoint, U) {
        /* *
         *
         *  Highcharts cylinder - a 3D series
         *
