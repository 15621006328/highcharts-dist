...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/SolidGauge/SolidGaugeSeries.js', [_modules['Core/Axis/SolidGaugeAxis.js'], _modules['Core/Series/Series.js'], _modules['Mixins/LegendSymbol.js'], _modules['Core/Utilities.js']], function (SolidGaugeAxis, BaseSeries, LegendSymbolMixin, U) {
        /* *
         *
         *  Solid angular gauge module
         *
