...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Organization/OrganizationPoint.js', [_modules['Core/Series/Series.js']], function (BaseSeries) {
        /* *
         *
    ...
    _registerModule(_modules, 'Series/Organization/OrganizationSeries.js', [_modules['Core/Series/Series.js'], _modules['Series/Organization/OrganizationPoint.js'], _modules['Core/Color/Palette.js'], _modules['Core/Utilities.js']], function (BaseSeries, OrganizationPoint, palette, U) {
        /* *
         *
         *  Organization chart module
         *
