...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Histogram/HistogramSeries.js', [_modules['Core/Series/Series.js'], _modules['Mixins/DerivedSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, DerivedSeriesMixin, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'Series/Bellcurve/BellcurveSeries.js', [_modules['Core/Series/Series.js'], _modules['Mixins/DerivedSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, DerivedSeriesMixin, U) {
        /* *
         *
