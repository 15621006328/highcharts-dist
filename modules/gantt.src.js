/**
 * @license Highcharts Gantt JS v8.2.2 (2020-12-15)
 *
 * Gantt series
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/XRange/XRangePoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Series/Point.js']], function (BaseSeries, Point) {
        /* *
         *
    ...
    _registerModule(_modules, 'Series/XRange/XRangeSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Globals.js'], _modules['Core/Color/Color.js'], _modules['Core/Utilities.js'], _modules['Series/XRange/XRangePoint.js']], function (BaseSeries, H, Color, U, XRangePoint) {
        /* *
         *
         *  X-range series module
         *
    ...
    _registerModule(_modules, 'Series/Gantt/GanttPoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'Series/Gantt/GanttSeries.js', [_modules['Core/Series/Series.js'], _modules['Series/Gantt/GanttPoint.js'], _modules['Core/Utilities.js']], function (BaseSeries, GanttPoint, U) {
        /* *
         *
         *  (c) 2016-2020 Highsoft AS
         *
            ...
            RangeSelector.prototype.alignElements = function () {
                ...
                if (group && buttonPosition && inputPosition) {
                    ...
                    if (buttonGroup) {
                        ...
                        var xOffsetForExportButton = getXOffsetForExportButton(buttonGroup,
                            buttonPosition);
                    ...
                    if (inputGroup) {
                        ...
                        var xOffsetForExportButton = getXOffsetForExportButton(inputGroup,
                            inputPosition);
