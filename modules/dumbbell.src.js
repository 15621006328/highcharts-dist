...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Dumbbell/DumbbellSeries.js', [_modules['Series/Dumbbell/DumbbellPoint.js'], _modules['Series/Column/ColumnSeries.js'], _modules['Series/Line/LineSeries.js'], _modules['Core/Series/Series.js'], _modules['Core/Renderer/SVG/SVGRenderer.js'], _modules['Core/Color/Palette.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (DumbbellPoint, ColumnSeries, LineSeries, BaseSeries, SVGRenderer, palette, H, U) {
        /* *
         *
         *  (c) 2010-2020 Sebastian Bochan, Rafal Sebestjanski
         *
