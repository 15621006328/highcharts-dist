...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Timeline/TimelinePoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
         *  Timeline Series.
         *
    ...
    _registerModule(_modules, 'Series/Timeline/TimelineSeries.js', [_modules['Core/Series/Series.js'], _modules['Mixins/LegendSymbol.js'], _modules['Core/Color/Palette.js'], _modules['Core/Renderer/SVG/SVGElement.js'], _modules['Series/Timeline/TimelinePoint.js'], _modules['Core/Utilities.js']], function (BaseSeries, LegendSymbolMixin, palette, SVGElement, TimelinePoint, U) {
        /* *
         *
         *  Timeline Series.
         *
