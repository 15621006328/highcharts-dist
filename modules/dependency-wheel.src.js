...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/DependencyWheel/DependencyWheelPoint.js', [_modules['Core/Series/Series.js'], _modules['Mixins/Nodes.js'], _modules['Core/Utilities.js']], function (BaseSeries, NodesMixin, U) {
        /* *
         *
         *  Dependency wheel module
         *
    ...
    _registerModule(_modules, 'Series/DependencyWheel/DependencyWheelSeries.js', [_modules['Core/Animation/AnimationUtilities.js'], _modules['Core/Series/Series.js'], _modules['Series/DependencyWheel/DependencyWheelPoint.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (A, BaseSeries, DependencyWheelPoint, H, U) {
        /* *
         *
         *  Dependency wheel module
         *
