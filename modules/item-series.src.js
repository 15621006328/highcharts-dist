...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Item/ItemPoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
    ...
    _registerModule(_modules, 'Series/Item/ItemSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Globals.js'], _modules['Series/Item/ItemPoint.js'], _modules['Core/Options.js'], _modules['Core/Utilities.js']], function (BaseSeries, H, ItemPoint, O, U) {
        /* *
         *
         *  (c) 2020 Torstein Honsi
         *
