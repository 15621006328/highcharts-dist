...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Variwide/VariwidePoint.js', [_modules['Core/Series/Series.js'], _modules['Core/Utilities.js']], function (BaseSeries, U) {
        /* *
         *
         *  Highcharts variwide module
         *
    ...
    _registerModule(_modules, 'Series/Variwide/VariwideSeries.js', [_modules['Core/Series/Series.js'], _modules['Series/Variwide/VariwidePoint.js'], _modules['Core/Utilities.js']], function (BaseSeries, VariwidePoint, U) {
        /* *
         *
         *  Highcharts variwide module
         *
