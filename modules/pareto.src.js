...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/ParetoSeries/ParetoSeries.js', [_modules['Core/Series/Series.js'], _modules['Mixins/DerivedSeries.js'], _modules['Core/Utilities.js']], function (BaseSeries, DerivedSeriesMixin, U) {
        /* *
         *
