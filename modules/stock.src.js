...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Candlestick/CandlestickSeries.js', [_modules['Core/Series/Series.js'], _modules['Core/Options.js'], _modules['Core/Color/Palette.js'], _modules['Core/Utilities.js']], function (BaseSeries, O, palette, U) {
        /* *
         *
         *  (c) 2010-2020 Torstein Honsi
         *
